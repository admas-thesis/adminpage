...
<html lang="en">
  ...
  <h5>Assigned Classes</h5>
    ...
    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#addclass">Assign New Class</button>
    <button href="print/printclass.php" type="button" class="btn btn-success btn-sm" style="float: right;"><span class="fa fa-print"></span> Print</button>
    <hr>   
