...
<html lang="en">
  ...
  <?php  
    ...
    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#addins">Assign New Instructor</button>
    <button href="print/printins.php" type="button" class="btn btn-success btn-sm" style="float: right;"><span class="fa fa-print"></span> Print</button>
    <hr>   
						...
						<?php
							...
							while($row = $query->fetch_assoc()){
                                ?>
								<tr>
						    		<td style="font-size: 14px;"><?php echo $row['ins_id']; ?></td>
