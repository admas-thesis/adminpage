...
#eighth{
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item" id="third">
      <div class="carousel-caption text-start d-none d-md-block">
        <h3>Our Faculty.</h3>
        <p>Well educated and  experienced faculty.</p>
        <a href="instructor.php" type="button" class="btn btn-success">Instructors</a>
      </div>
    </div>
  ...
  <div class="carousel-item" id="fifth">
      <div class="carousel-caption d-none d-md-block">
        <h3>Sections.</h3>
        <p>Check out available sections.</p>
        <a href="section.php" type="button" class="btn btn-success">Sections</a>
      </div>
    </div>
