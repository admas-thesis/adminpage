...
<div class="container">
  <h5>Student List</h5>
    ...
    <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#printstud" style="float: right;"><span class="fa fa-print"></span>Print</button>
    <hr>   
