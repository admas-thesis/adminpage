            ...
            <div class="row">
                ...
                <select class="form-select" name="course" id="course" required>
                       <option value="" disabled= ""selected="">Select Course</option>
                        <?php 
                        $co ="SELECT distinct course_id,course_code,course_name,ins_name FROM course_comb join courses on courses_course_id = course_id
                        join instructors on instructors_ins_id = ins_id where ins_name = '".$_SESSION['ins_name']."'";
                ...
                <select class="form-select" name="section" id="section" required>
                        ...
                        <?php 
                        $result ="SELECT sec_id,sec_name,ins_name FROM course_comb join sections on sections_sec_id = sec_id
                        join instructors on instructors_ins_id = ins_id where ins_name = '".$_SESSION['ins_name']."'";
