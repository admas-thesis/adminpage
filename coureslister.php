<?php
     ...
     if(!empty($_POST["section_id"])){ 
        ...
        $query="select course_id, course_code, course_name from course_comb join courses on courses_course_id = course_id join sections on sections_sec_id = sec_id where sec_id = '$_POST[section_id]' ";
